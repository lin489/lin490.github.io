; if (typeof Cesium !== 'undefined')
    ...
    Cesium.Measure = (function (Cesium) {
        ...
        _.prototype = {
             ...
             * 坐标转换 84转笛卡尔
             * 
             * @param {Object} {lng,lat,altitude} 地理坐标
             * 
             * @return {Object} Cartesian3 三维位置坐标
             */
            transformWGS84ToCartesian: function (position, altitude) {
                if (this._viewer) {
                    return position
                        ? Cesium.Cartesian3.fromDegrees(
                            position.lng || position.lon,
                            position.lat,
                            position.altitude = altitude || position.altitude,
            ...
            * 坐标数组转换 笛卡尔转84
            * 
            * @param {Array} WSG84Arr {lng,lat,altitude} 地理坐标数组
            * @param {Number} altitude 拔高
            * @return {Array} Cartesian3 三维位置坐标数组
            */
            transformWGS84ArrayToCartesianArray: function (WSG84Arr, altitude) {
             ...
             * 
             * @return {Object} {lng,lat,altitude} 地理坐标
             */
            ...
            * 
            * @return {Array} {lng,lat,altitude} 地理坐标数组
            */
            ...
            */
            ...
            drawAreaMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    _handler.setInputAction(function (movement) {
                        ...
                        newEntity = polyObj 
                        AddProperties(options.rsMode,($this.getPositionsArea($this.transformCartesianArrayToWGS84Array(positions)) / 1.0).toFixed(4));
                        ...
                        try{
                            viewer0.dataSources._dataSources.forEach(datasource => {
                                if (datasource._name == 'geojson/通化所有数据.geojson') {
                                    datasource.entities.add(_polygonEntity);
                                }
                            });
                        }
                        catch(error){
                    ...
                    function _addInfoPoint(position) {
                        ...
                        // }
                        // _labelEntity.label = {
                        //     text: '空间面积：'+ ($this.getPositionsArea($this.transformCartesianArrayToWGS84Array(positions)) / 1.0).toFixed(4) + '平方米',
                        //     show: true,
                        //     showBackground: true,
                        //     font: '30px monospace',
                        //     horizontalOrigin: Cesium.HorizontalOrigin.LEFT,
            ...
            drawTrianglesMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    // _trianglesEntity.label.position = new Cesium.CallbackProperty(function () {
                    //     let temppos0;
                    //     let temppos1;
                    //     if(_positions[0]!=null){
                    //         temppos0 = $this.transformCartesianToWGS84(_positions[0]);
                    //         temppos1 = $this.transformCartesianToWGS84(_positions[1]);
                    //     }else{
                    //         return _positions[0]
                    //     }
                    //     return Cesium.Cartesian3.fromDegrees( temppos0.lng/2+temppos1.lng/2,temppos0.lat/2+temppos1.lat/2,temppos0.alt/2+temppos1.alt/2)
                    // }, false)
                    ...
                    _trianglesEntity.label = {
                        ...
                        horizontalOrigin: Cesium.HorizontalOrigin.LEFT,
                        verticalOrigin: Cesium.VerticalOrigin.BOTTOM,
                        pixelOffset: new Cesium.Cartesian2(50, -40), //left top
                        disableDepthTestDistance:50000
                    }
                    //高度
                    ...
                    _tempLineEntity.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return '高度:' + _getHeading(_tempPoints[0], _tempPoints[1]) + '米'+'\n'+'坡度:' + (_getHeading(_tempPoints[0], _tempPoints[1])/$this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_tempPoints2))*100).toFixed(2) + '%'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '30px monospace',
